...
object UrlParser{
    ...
    private const val DOGS = "https://dog.ceo/api/breeds/image/"
    private const val RON_SWANSON = "https://ron-swanson-quotes.herokuapp.com/v2/"
    private const val ADVICE = "https://api.adviceslip.com/"
